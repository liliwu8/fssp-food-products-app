...
('Ceviche', 'Ceviche', 500, 'Lima, Peru', 'https://www.eatperu.com/wp-content/uploads/2020/06/authentic-peru-ceviche-with-onion-sweet-potato.jpg', 'fish, octopus, lime juice, salt, pepper'),
...
INSERT INTO reviews (foods_id, reviewer, content, rating )
VALUES
('1', 'Evan', 'this is ok', 3),
('2', 'Evan', 'this is average', 3),
('3', 'Evan', 'love it', 5),
('2', 'Juliana', 'finally ate here', 5),
('2', 'David', 'disappointing', 1),
('2', 'Mr. Mingo', 'I got some to try it but its meh', 3),
('2', 'Alison', 'the best place to eat', 4),
('3', 'Hannah', 'came here and waited for hours', 4),
('3', 'Gabi', 'Gets a discount if I cam again great place to eat', 5);